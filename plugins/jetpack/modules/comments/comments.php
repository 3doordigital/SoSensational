...
class Jetpack_Comments extends Highlander_Comments_Base {
	...
	public function comment_form_after() {
		...
		$params  = array(
			...
			'greeting'             => get_option( 'highlander_comment_form_prompt', __( 'So, what do you think?', 'jetpack' ) ),
			/**
			 ...
			 */
			'greeting_reply'       => apply_filters( 'jetpack_comment_form_prompt_reply', __( 'So, what do you think? to %s' , 'jetpack' ) ),
