...
if (empty($post_categories_available)) {
    ...
    if ($my_query->have_posts()) : while ($my_query->have_posts()) : $my_query->the_post();
            ...
            <?php if (get_post_status(get_the_ID()) == "publish") {
                echo '<span  aria-describedby="basic-addon1"  class="form-control label-success">Published</span>';
            } else {
                echo '<span class=" form-control label-warning">Awaiting Review</span>';
            } ?>
                            </div>
