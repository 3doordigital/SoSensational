		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by WordPress Affiliate Shop plugin, this is an XML Sitemap, meant for consumption by search engines.<br/>
				...
				<script type="text/javascript" src="http://www.sosensational.co.uk/wp-content/plugins/wordpress-seo/js/jquery.tablesorter.min.js"></script>
