...
<span data-name="Scheduler" data-shortcode="scheduler" title="Allows to show the content only at the specified time period" data-desc="Allows to show the content only at the specified time period" data-group="other"><i class="fa fa-clock-o"></i>Scheduler</span>
				...
				<input type="hidden" name="su-generator-selected" id="su-generator-selected" value="http://sosen.3doordigital.com/wp-content/plugins/shortcodes-ultimate" />
				<input type="hidden" name="su-generator-url" id="su-generator-url" value="http://sosen.3doordigital.com/wp-content/plugins/shortcodes-ultimate" />
