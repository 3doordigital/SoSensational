...
#mega-menu-wrap-primary #mega-menu-primary.mega-no-js li.mega-menu-item:hover > ul.mega-sub-menu, #mega-menu-wrap-primary #mega-menu-primary li.mega-toggle-on > ul.mega-sub-menu {
  display: block;
}
...
#mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-megamenu > ul.mega-sub-menu > li.mega-menu-item > a, #mega-menu-wrap-primary #mega-menu-primary > li.mega-menu-megamenu > ul.mega-sub-menu > li.mega-menu-item > h4.mega-block-title {
  color: #555;
  font-family: inherit;
  font-size: 16px;
...
#mega-menu-wrap-primary .mega-menu-toggle {
  ...
  -ms-border-radius: 2 2 2 2;
  -o-border-radius: 2 2 2 2;
